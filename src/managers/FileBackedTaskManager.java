    ...
    public static void loadFromFile() throws IOException {
        try (BufferedReader uploadTasks = new BufferedReader(new FileReader(dataBase))) {
            while (uploadTasks.ready()) {
                ...
                } else if (currentTask[0].equals("Epic")) {
                ...
                } else if (currentTask[0].equals("Sub")) {
                    SubTask uploadingSub = new SubTask(currentTask[2], currentTask[3], TaskStatus.valueOf(currentTask[4]),
                            Integer.parseInt(currentTask[5]));
